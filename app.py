...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://Olawale@localhost:5432/fyyur-db'
...
class Artist(db.Model):
    ...
    # TODO: implement any missing fields, as a database migration using Flask-Migrate
    website_link = db.Column(db.String(120))
    seeking_venues  = db.Column(db.Boolean, default = False, nullable = True)
    seeking_description = db.Column(db.String(120))
...
def create_venue_submission():
  ...
  try:
    ...
    venue = Venue(name = name, city = city , state = state, phone = phone, address = address, genres = genres, facebook_link = facebook_link, website_link = website_link, image_link = image_link, seeking_description = seeking_description)
...
def create_artist_submission():
  ...
  try:
    ...
    genres = request.form['genres']
    image_link = request.form['image_link']
    # seeking_venues = request.form['seeking_venue']
    seeking_description = request.form['seeking_description']
    artist = Artist(name = name, city = city , state = state, phone = phone, genres = genres, facebook_link = facebook_link, website_link =website_link, image_link = image_link, seeking_description = seeking_description )
